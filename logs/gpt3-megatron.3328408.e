/ccs/home/sajaldash/.lsbatch/1709524856.3328408.shell: line 95: export: `--deepspeed': not a valid identifier
/ccs/home/sajaldash/.lsbatch/1709524856.3328408.shell: line 95: export: `--deepspeed_config': not a valid identifier
/ccs/home/sajaldash/.lsbatch/1709524856.3328408.shell: line 95: export: `ds_config.json': not a valid identifier
...
Traceback (most recent call last):
  ...
  File "/gpfs/alpine2/stf218/world-shared/sajal/Megatron-DeepSpeed/megatron/training.py", line 525, in setup_model_and_optimizer
    model = model_provider_func(
            ^^^^^^^^^^^^^^^^^^^^
  File "/gpfs/alpine2/stf218/world-shared/sajal/Megatron-DeepSpeed/pretrain_gpt.py", line 47, in model_provider
            ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/gpfs/alpine2/stf218/world-shared/sajal/Megatron-DeepSpeed/megatron/training.py", line 364, in get_model
    model = model_provider_func(
            ^^^^^^^^^^^^^^^^^^^^
...
Traceback (most recent call last):
  File "/gpfs/alpine2/stf218/world-shared/sajal/Megatron-DeepSpeed/pretrain_gpt.py", line 356, in <module>
    model = model_provider_func(
            ^^^^^^^^^^^^^^^^^^^^
  File "/gpfs/alpine2/stf218/world-shared/sajal/Megatron-DeepSpeed/pretrain_gpt.py", line 47, in model_provider
AttributeError: 'Namespace' object has no attribute 'deepspeed_config_dict'. Did you mean: 'deepspeed_config'?
AttributeError: 'Namespace' object has no attribute 'deepspeed_config_dict'. Did you mean: 'deepspeed_config'?
    pretrain(train_valid_test_datasets_provider,
  File "/gpfs/alpine2/stf218/world-shared/sajal/Megatron-DeepSpeed/megatron/training.py", line 163, in pretrain
    model, optimizer, opt_param_scheduler = setup_model_and_optimizer(
