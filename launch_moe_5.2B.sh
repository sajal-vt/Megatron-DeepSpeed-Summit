...
#BSUB -o logs/moe-5.2b-8e.%J.o
#BSUB -e logs/moe-5.2b-8e.%J.e
##BSUB -q debug
...
time jsrun --nrs 48 --tasks_per_rs 1 --cpu_per_rs 7 --gpu_per_rs 1 --rs_per_host 6 --latency_priority CPU-CPU --launch_distribution packed --bind packed:1 python pretrain_gpt.py ${megatron_options} ${data_options} ${deepspeed_options} --num-workers 1
